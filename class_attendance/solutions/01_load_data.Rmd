...
Now it's your turn. There is another CSV file we need to load in called *class_b.csv* located in the *data* folder. Your task is to read that file into a tibble called `class_b_df` and view the data in this notebook.

```{r read_data_exercise}
# TODO: Read class_b.csv into a tibble called class_b_df
# YOUR CODE BELOW
